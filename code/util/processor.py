...
class FiqaProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        train_data = pd.read_csv(os.path.join(data_dir, "acd_1_headline_crr_train_chinese.csv")).values
        return self._create_examples(train_data, "train")
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        test_data = pd.read_csv(os.path.join(data_dir, "acd_1_headline_crr_test_chinese.csv")).values
        return self._create_examples(test_data, "test")
